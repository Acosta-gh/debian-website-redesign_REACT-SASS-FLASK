...
const IntroSection = () => {
    ...
    const descriptions = translations.introSection.descriptions[language];
    ...
    return (
        <section className="home-content-intro">
            ...
            <Fade cascade triggerOnce damping={0.18}>
                ...
                <h3 className="home-content-intro__subtitle">{translations.introSection.subtitle[language]}</h3>
                ...
                <div className='home-content-intro__special-feature-mobile'>
                    <div className="home-content-intro__buttons">
                        ...
                        {translations.introSection.tryDebian[language]}
                        ...
                        <Link to="/" className="home-content-intro__button">
                        {translations.introSection.learnMore[language]}
                        </Link>
                    </div>
