        ...
        <section className='home-content-performance'>
                ...
                <div className='home-content-performance__text '>
                    <Slide triggerOnce >
                        <h3 className='home-content-performance__text--title'>
                            {translations.performanceSection.title_speed[language]}
                    ...
                    <Slide triggerOnce>
                        <p>  {translations.performanceSection.paragraph_speed[language]} </p>
                    </Slide>
                </div>
            ...
            <div className='home-content-performance__block home-content-performance__block--second'>
                ...
                <div className='home-content-performance__text home-content-performance__text--second'>
                    <Slide triggerOnce direction="right">
                        <h3 className='home-content-performance__text--title home-content-performance__text--title--second'>{translations.performanceSection.title_green[language]}</h3>
                    </Slide>
                    <Slide triggerOnce direction="right">
                        <p>{translations.performanceSection.paragraph_green[language]}</p>
                    </Slide>
                </div>
            </div>
        </section >
